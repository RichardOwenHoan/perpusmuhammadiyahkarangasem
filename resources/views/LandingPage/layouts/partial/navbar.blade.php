<header class="clearfix">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <a class="navbar-brand" style="margin-right: 0px;" href="{{ route('landing.home') }}">
                <img src="/LP/assets/images/logo3.png" style="margin-right: 0px;" width="70px" alt="Perpustakaan SMP Muhammadiyah">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="drop-link">
                        <a href="{{ route('landing.books') }}" class="{{ request()->routeIs('landing.books*') ? 'active' : '' }}">Koleksi Buku <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown">
                            <li><hr class="dropdown-divider"></li>
                            {{-- <li><strong class="dropdown-header">Kategori Buku</strong></li> --}}
                            <li><a href="{{ route('landing.books') }}">Semua Kategori</a></li>
                            @foreach($navbarCategories as $category)
                                <li><a href="{{ route('landing.books') }}?category={{ $category->id }}">{{ $category->name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('landing.about') ? 'active' : '' }}" href="{{ route('landing.about') }}">Tentang Kami</a>
                    </li>
                    @auth
                        @if(auth()->user()->isSiswa())
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('siswa.books.loans.history') ? 'active' : '' }}" href="{{ route('siswa.books.loans.history') }}">Riwayat Peminjaman</a>
                        </li>
                        @endif
                    @endauth
                ...
                <a href="/dashboard/books" class="register-modal-opener login-button" style="background-color: #52843e; color: #fff; margin-right: 10px;"> Dashboard</a>
                @endif
                ...
                @else
                    <a href="{{ route('login') }}" class="register-modal-opener login-button"><i class="material-icons">perm_identity</i> Masuk</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <div class="mobile-menu">
            ...
            <ul class="mobile-menu-list">
                ...
                <li class="drop-link">
                    ...
                    <ul class="mobile-dropdown">
                        <li><a href="{{ route('landing.books') }}?sortBy=created_at&sortDirection=desc">Buku Terbaru</a></li>
        ...
        @if(auth()->user()->role === 'admin')
        <a href="/dashboard/books" class="register-modal-opener login-button" style="background-color: #52843e; color: #fff; margin-right: 20px;"> Dashboard</a>
        @endif
